...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comment', '0005_auto_20190310_1557'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply_parent', to='comment.Comment'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='reply_to',
